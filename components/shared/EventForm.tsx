          ...
          if(!eventId){
            ...
            try {
              ...
              const updatedEvent = await updateEvent({
                userId,
                event:{...values, imageUrl: uploadedImageUrl, _id:eventId as string},
                path:`/events/${eventId}`
              })
                      ...
                      <FormItem>
                        <FormControl>
                          <div className="flex items-center">
                              <label htmlFor="isFree" className="whitespace-nowrap py-3 leading-none 
                              peer-disabled:curson-not-allowed peer-disabled:opacity-70">Free Ticket</label>
